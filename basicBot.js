...
(function () {
    ...
    var basicBot = {
        ...
        chatUtilities: {
            ...
            curses: [
                'nigger', 'faggot', 'nigga', 'niqqa', 'motherfucker', 'modafocka', 'retard', 'cunt', 'pussy', 'bitch', 'rape', 'penis', 'cock', 'vagina', 'whore', 'hooker', 'boobs', 'tits', 'anal', 'balls', 'nutsack', 'jizz', 'cum', 'semen'
            ]
        },
        connectAPI: function () {
            this.proxy = {
        ...
        commands: {
            ...
            cookieCommand: {
                ...
                cookies: ['has given you a chocolate chip cookie!',
                    ...
                    'gives you an enormous cookie. It says "Happy Birthday Matthew!" Weird.',
                    'gives you a fortune cookie. It reads "Why aren\'t you working on homework?"',
                    'gives you a fortune cookie. It reads "Give that special someone a compliment"',
                    'gives you a fortune cookie. It reads "Don\'t eat this."',
                    'gives you a fortune cookie. It reads "Go outside."',
                    'gives you a fortune cookie. It reads "Don\'t forget to eat your veggies!"',
                    'gives you a fortune cookie. It reads "Do you even lift brah?"',
                    'gives you a fortune cookie. It reads "pls .-."',
